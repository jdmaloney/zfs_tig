...
stat_line=""
	...
	done < <(/usr/sbin/zfs get all ${d} -p | awk '$2 == "compressratio" || $2 == "referenced" || $2 == "written" || $2 == "logicalused" || $2 == "logicalreferenced" || $2 == "used" || $2 == "refcompressratio" || $2 == "available" {print $2" "$3}')
